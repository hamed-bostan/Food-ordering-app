...
const LogoutDialogContext = createContext<LogoutDialogContextProps | null>(null);
...
export const LogoutDialogProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <LogoutDialogContext.Provider value={{ isLogoutDialogOpen, openLogoutDialog, closeLogoutDialog }}>
      {children}
