import { FoodCategoriesCardProps } from "@/types/menu.types";
import ArrowBackOutlinedIcon from "@mui/icons-material/ArrowBackOutlined";

export default function FoodCategoriesCard({ item, setSelectedCategory, isSelected }: FoodCategoriesCardProps) {
  return (
    <button
