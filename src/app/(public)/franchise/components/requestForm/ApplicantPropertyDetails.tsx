...
import { FormControl, InputLabel, Select, SelectChangeEvent, MenuItem, FormHelperText } from "@mui/material";
    ...
    <div className="mb-12">
      ...
      <div className="flex gap-x-4">
        <FormControl fullWidth size="small" error={!!errors.ownershipType}>
          ...
          <FormHelperText>{getErrorMessage(errors.ownershipType)}</FormHelperText>
        </FormControl>
        <Input
