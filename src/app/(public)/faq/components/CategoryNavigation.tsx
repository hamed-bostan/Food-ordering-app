import { categoryNavigationItems } from "@/presentation/constants/faq";
import { CategoryNavigationProps } from "@/types/faq.types";

export default function CategoryNavigation({ handleTabClick, activeTab }: CategoryNavigationProps) {
  return (
