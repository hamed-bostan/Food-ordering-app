...
import { testimonialFormSchema, TestimonialFormModel } from "@/domain/testimonial-form.schema";
...
// Default form values
export const defaultTestimonial: Partial<TestimonialFormModel> = {
  name: "محمد محمدی",
  date: "۱۴۰۳/۰۶/۰۱",
...
export default function TestimonialUploadPanel({ accessToken }: Props) {
  ...
  const onSubmit = async (data: TestimonialFormModel) => {
